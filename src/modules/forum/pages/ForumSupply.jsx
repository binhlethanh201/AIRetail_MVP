			...
			<div className="relative mx-auto flex max-w-[1200px] gap-4">
				...
				<main className="min-w-0 flex-1 bg-surface py-4 pb-24 lg:pb-10">
					<div className="grid gap-8 p-6 lg:grid-cols-12 lg:p-10">
						<div className="space-y-8 lg:col-span-8">
							<section>
								...
								<p className="max-w-2xl text-sm text-on-surface-variant md:text-base">
									Kết nối nhà phân phối, đại lý và xưởng sản xuất thiết bị kim khí, dụng cụ cầm
									tay, bulong ốc vít và phụ kiện cơ khí trên toàn quốc.
								</p>
							</section>
						...
						<aside className="hidden xl:flex xl:sticky xl:top-[72px] xl:h-fit xl:w-80 xl:flex-col xl:gap-lg xl:px-gutter xl:py-lg">
							...
							<section className="rounded-2xl border border-slate-100 bg-white p-5 shadow-sm">
								...
								<div className="mb-3.5 overflow-hidden rounded-xl border border-slate-50">
									<img alt="Featured" className="aspect-video h-full w-full object-cover" src={featuredSale.image} />
								</div>
								<p className="mb-1.5 text-xs font-bold text-slate-700 leading-snug">{featuredSale.title}</p>
								<p className="mb-4 text-caption leading-relaxed text-slate-500">{featuredSale.description}</p>
